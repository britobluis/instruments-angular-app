...
$instrumentos = '[{
	...
	"instrumento": "Instrumento De Percusión Niños Set Musical Con Estuche ",
	"marca": "KNIGHT",
	"modelo": "LB17",
	"imagen": "assets/img/nro1.jpg",
	"precio": "2700",
	"costoEnvio": "300",
	"cantidadVendida": "15",
	"descripcion": "Estas viendo un excelente y completísimo set de percusión para niños con estuche rígido, equipado con los instrumentos más divertidos! De gran calidad y sonoridad. Ideal para jardines, escuelas primarias, musicoterapeutas o chicos que se quieran iniciar en la música de la mejor manera. Es un muy buen producto que garantiza entretenimiento en cualquier casa o reunión, ya que está equipado para que varias personas al mismo tiempo estén tocando un instrumento"
}, {
	"instrumento": "Batería Musical Infantil Juguete Niño 9 Piezas Palillos ",
	"marca": "Bateria",
	"modelo": "Infantil",
	"imagen": "assets/img/nro5.jpg",
	"precio": "850",
	"costoEnvio": "250",
	"cantidadVendida": "380",
...
$instrumentos = removeInvalidChars($instrumentos);
echo $instrumentos;
?>